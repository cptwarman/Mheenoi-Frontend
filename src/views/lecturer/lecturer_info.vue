...
export default {
    ...
    methods: {
        ...
        infoSubmit() {
            ...
            axios({
                method: 'put',
                url: `https://chai-test-backend.herokuapp.com/api/employees/${this.$store.getters.getId}/info`,
                data: { 
    ...
    created() {
        ...
        axios({
            method: 'get',
            url: `https://chai-test-backend.herokuapp.com/api/lecturers/${this.$store.getters.getId}/info`,
            headers: {
                Authorization: `bearer ${jwtToken}`
            }
        })
