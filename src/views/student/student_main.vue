            ...
            <v-row justify="space-around">
              ...
              <v-col lg="6">
                <v-row justify="center" class="mr-5">
                  ...
                  <v-card  hover height="178" width="315" class="mt-1" href="/#/student_info">
                  ...
                  <v-card  hover height="178" width="315" class="ml-1 mt-1" href="/#/scholarship">
                    <v-card-text class="text-center mt-3">
                ...
                <v-row justify="center" class="mr-5">
                  ...
                  <v-card  hover height="178" width="315" class="mt-1"  href="/#/enrollment_form">
                    <v-card-text class="text-center mt-3">
                  ...
                  <v-card  hover height="178" width="315"  class="ml-1 mt-1"  href="/#/enrollment_details">
                    <v-card-text class="text-center mt-3">
                      <img src="../../assets/detail.png" class="mt-3">
                      <p class="mt-2">Enrollment Details</p>
                    </v-card-text>
                  </v-card>
